...
public class SrchResults extends Activity{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        siz=(int)TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP,9,getResources().getDisplayMetrics());
       ...
       if(i==1)
       {
        ...
        if(!(transId==null))
        { try{
        	Cursor c=db1.rawQuery("SELECT * FROM Transactions WHERE TransactionId='"+transId+"' ORDER BY Dat DESC;",null);
        if(c.getCount()==0)
        ...
        catch(Exception e){Toast.makeText(getApplicationContext(), "No records found", Toast.LENGTH_SHORT);
        }
        	}
